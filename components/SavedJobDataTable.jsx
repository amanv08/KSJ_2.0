      ...
      },
      {
        ...
        cell: (row) => (
          <button
            ...
            className="md:px-2 md:py-2 px-1 py-1 text-xs text-indigo-600 hover:text-white my-2 hover:bg-slate-700 border border-indigo-600   rounded transition-all duration-700  "
          >
            View Details
          </button>
        ),
